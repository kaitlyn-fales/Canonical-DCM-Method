...
for rep_id = 1:n_reps
    ...
    DCM.delays(1:n_regions) = DCM.Y.dt/2;
    DCM.TE = 0.04;
    ...
    %% Load replicate data
    filename = sprintf( ...
        'Balloon_Simulation/Data/balloon_sim_diagAB_nonzero_data_rep%03d.mat', ...
        rep_id ...
    );
    ...
    %% Save and estimate
    output = sprintf( ...
        'Balloon_Simulation/Output/balloon_diagAB_nonzero_rep%03d.mat', ...
        rep_id ...
    );
    ...
    output_compact = sprintf( ...
        'Balloon_Simulation/Output/balloon_diagAB_nonzero_rep%03d_out.mat', ...
        rep_id ...
    );
