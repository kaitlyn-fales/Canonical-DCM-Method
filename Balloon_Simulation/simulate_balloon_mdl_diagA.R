...
summary_zero <- generate_balloon_reps(
  delay_label = "zero",
  signal_file = "balloon_sim_signal_diagA_zero.mat",
  out_prefix = "balloon_sim_diagA_zero"
)

# Generate nonzero-delay replicates
summary_nonzero <- generate_balloon_reps(
  delay_label = "nonzero",
  signal_file = "balloon_sim_signal_diagA_nonzero.mat",
  out_prefix = "balloon_sim_diagA_nonzero"
)
