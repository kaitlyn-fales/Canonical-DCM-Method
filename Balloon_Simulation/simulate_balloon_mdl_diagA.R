...
SPM <- readMat("Balloon_Simulation/Data/balloon_sim_signal_diagA_zero.mat")
BOLD <- SPM$y.signal
u <- SPM$U
...
save(dat, file = "Balloon_Simulation/Data/balloon_sim_data_diagA_zero.RData")

# Write observed signal to a MATLAB file for SPM
writeMat("Balloon_Simulation/Data/balloon_sim_data_diagA_zero.mat",
         U = dat$u,
         Y = dat$y_obs)
...
# Load in SPM-generated balloon signal
SPM <- readMat("Balloon_Simulation/Data/balloon_sim_signal_diagA_nonzero.mat")
BOLD <- SPM$y.signal
u <- SPM$U
...
# Save/export data
dat <- list(times = times[-1], u = u, y_obs = y_obs, true_signal = (BOLD * scale))
save(dat, file = "Balloon_Simulation/Data/balloon_sim_data_diagA_nonzero.RData")

# Write observed signal to a MATLAB file for SPM
writeMat("Balloon_Simulation/Data/balloon_sim_data_diagA_nonzero.mat",
         U = dat$u,
         Y = dat$y_obs)
