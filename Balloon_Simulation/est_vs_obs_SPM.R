...
# Load in predicted signal (SPM)
SPM <- readMat("Balloon_Simulation/Output/balloon_diagA_out.mat")
y_pred <- SPM$DCM.y

# Load in observed signals (data)
dat <- readMat("Balloon_Simulation/Data/balloon_sim_data_diagA.mat")
times <- seq(0, 300, 2)
y_obs <- dat$Y
...
# Load in predicted signal (SPM)
SPM <- readMat("Balloon_Simulation/Output/balloon_diagAB_out.mat")
y_pred <- SPM$DCM.y

# Load in observed signals (data)
dat <- readMat("Balloon_Simulation/Data/balloon_sim_data_diagAB.mat")
times <- seq(0, 300, 2)
y_obs <- dat$Y
