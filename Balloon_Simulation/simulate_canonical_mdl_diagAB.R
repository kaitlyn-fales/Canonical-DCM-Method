...
nu = list(nu_A = c(0.4,0.3,-0.1,0.15), nu_B = c(-0.2,0.05), nu_C=c(0.7)) 
...
save(true_signal, file = "Balloon_Simulation/Data/canonical_sim_signal_diagAB.RData")
#############################
...
writeMat("Balloon_Simulation/Data/canonical_sim_data_diagAB.mat",
         U = dat$u,
         Y = dat$y_obs)
