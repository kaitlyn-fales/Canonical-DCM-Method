...
for rep_id = 1:n_reps
    ...
    %% Load replicate data
    filename = sprintf( ...
        'Balloon_Simulation/Data/balloon_sim_diagA_nonzero_data_rep%03d.mat', ...
        rep_id ...
    );
    ...
    %% Save and estimate
    output = sprintf( ...
        'Balloon_Simulation/Output/balloon_diagA_nonzero_rep%03d.mat', ...
        rep_id ...
    );
    ...
    output_compact = sprintf( ...
        'Balloon_Simulation/Output/balloon_diagA_nonzero_rep%03d_out.mat', ...
        rep_id ...
    );
