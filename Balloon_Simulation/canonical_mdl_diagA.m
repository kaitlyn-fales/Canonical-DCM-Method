...
for rep_id = 1:n_reps
    ...
    %% Load replicate data
    filename = sprintf( ...
        'Balloon_Simulation/Data/canonical_sim_data_diagA_rep%03d.mat', ...
        rep_id ...
    );
    ...
    %% Save and estimate
    output = sprintf( ...
        'Balloon_Simulation/Output/canonical_diagA_rep%03d.mat', ...
        rep_id ...
    );
    ...
    output_compact = sprintf( ...
        'Balloon_Simulation/Output/canonical_diagA_rep%03d_out.mat', ...
        rep_id ...
    );
