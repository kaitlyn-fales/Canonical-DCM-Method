...
nu = list(nu_A = c(0.4,0.3), nu_B = c(-0.2), nu_C=c(0.3))
...
# Save/export data
save(dat, file = "Computational_Efficiency_Sim/Data/dat_simple_mdl_diag_fix.RData")
...
##########################
m = 2; n_u = 2; max_time = 150*2
nu = list(nu_A = c(0.4,0.3,rep(0.1,m)), nu_B = c(-0.2), nu_C=c(0.3))
idxs = list(A_idxs = matrix(c(2,1,
                              1,2,
                              1,1,
                              2,2), byrow = T, ncol=2),
...
# Save/export data
save(dat, file = "Computational_Efficiency_Sim/Data/dat_simple_mdl_diag_var.RData")
