...
ggplot(df, aes(x = x, y = mean)) +
  ...
  ggtitle("Simple Model: Piecewise Analytic Solution (Fixed Diagonal)") +
...
ggplot(df, aes(x = x, y = mean)) +
  ...
  geom_errorbar(aes(ymax = q95, ymin = q5), linewidth = 0.8, width = 0.5) +
  geom_hline(yintercept = 0, linetype = "dotted") +
  ggtitle("Simple Model: CKRK Numeric Solver (Fixed Diagonal)") +
  labs(x = "Parameter", y = "Estimate") + ylim(c(-0.5,0.5)) + 
  theme(axis.text.x = element_blank(),
        axis.ticks.x = element_blank(),
        panel.background = element_blank(),
...
ggplot(df, aes(x = x, y = mean)) +
  ...
  geom_hline(yintercept = 0, linetype = "dotted") +
  ggtitle("Complex Model: Piecewise Analytic Solution (Fixed Diagonal)") +
...
ggplot(df, aes(x = x, y = mean)) +
  ...
  geom_errorbar(aes(ymax = q95, ymin = q5)) +
  geom_hline(yintercept = 0, linetype = "dotted") +
  ggtitle("Complex Model: CKRK Numeric Solution (Fixed Diagonal)") +
  labs(x = "Parameter", y = "Estimate") + ylim(c(-3,2)) + 
  theme(axis.text.x = element_blank(),
        axis.ticks.x = element_blank(),
        panel.background = element_blank(),
