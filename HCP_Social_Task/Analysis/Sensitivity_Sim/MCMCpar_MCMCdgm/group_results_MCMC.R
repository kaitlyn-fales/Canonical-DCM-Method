...
for (i in 1:length(conditions)){
  load(paste0("HCP_Social_Task/Analysis/Sensitivity_Sim/MCMCpar_MCMCdgm/Output/",conditions[i],"_MCMC.RData"))
...
save(MCMC_results, file = "HCP_Social_Task/Analysis/Sensitivity_Sim/MCMCpar_MCMCdgm/MCMC_results.RData")
