...
for s = 1:length(subjects)
    ...
    for c = 1:length(conditions)
        ...
        % back
        load("HCP_Social_Task/SPM/Results/SPM_results.mat");
        
        % Choose group level phase and mask
        results = str2double(SPM_results.(cond)(:,2));
        ...
        clear SPM_results results a_diag b_diag a_raw b_raw temp
        ...
        y_signal = Y.y;  
        save_path = sprintf('HCP_Social_Task/SPM/Sensitivity_Sim/SPMpar_SPMdgm/Data/sub_%d_%s.mat', subj, cond);
