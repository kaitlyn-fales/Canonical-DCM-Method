...
for (i in 1:length(conditions)){
  load(paste0("HCP_Social_Task/SPM/Sensitivity_Sim/SPMpar_SPMdgm/Output/",conditions[i],"_MCMC.RData"))
...
save(MCMC_results, file = "HCP_Social_Task/SPM/Sensitivity_Sim/SPMpar_SPMdgm/MCMC_results.RData")
