...
for (i in 1:length(conditions)){
  load(paste0("HCP_Social_Task/SPM/Sensitivity_Sim/MCMCpar_SPMdgm/Output/",conditions[i],"_SPM.RData"))
...
save(SPM_results, file = "HCP_Social_Task/SPM/Sensitivity_Sim/MCMCpar_SPMdgm/SPM_results.RData")
