...
nu = list(nu_A = c(0.4,0.3,1,0.9), nu_B = c(-0.2), nu_C=c(0.3))
...
round(analytic_sol-numeric_sol[,-1],digits=4)
##########################
...
par(mfrow = c(2,1))
for (i in 1:m) plot(y_obs_ana[,i], type = 'l', col = i, ylim = c(-0.1,0.5))
#############################
...
solve(cbind(sim_dat$y_obs[3:5,],1))
solve(cbind(sim_dat$y_obs[13:15,],1))
